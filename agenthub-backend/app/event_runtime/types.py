...
MESSAGE_EVENT_OPERATION_HINTS: dict[str, str] = {
    ...
    MessageEventType.Task.TASK_COMPLETED: "任务完成",
    MessageEventType.Task.TASK_FAILED: "任务失败",
    MessageEventType.Task.TASK_REVIEWED: "任务复核",
    MessageEventType.Task.TASK_REQUEUED: "任务重新入队",
    MessageEventType.Task.NODE_EXEC_STARTED: "节点执行开始",
    MessageEventType.Task.NODE_EXEC_FINISHED: "节点执行结束",

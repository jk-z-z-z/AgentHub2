    ...
    <section class="section">
      ...
      <template v-else>
        <div class="kvRow">
          ...
          <span class="v">
            <el-switch
              v-model="assistantEnabledModel"
              :disabled="assistantCfgSaving || assistantCfgLoading"
              @change="$emit('save-assistant-config')"
            />
          </span>
        </div>
        <div class="kvRow">
...
import type { Group, MemoryCompressorConfig, MemoryCompressorStatus } from '@/api/models.ts'

...
.searchBar :deep(.el-input__wrapper) { height:38px; border-radius:12px; box-shadow:none; background:rgba(31,35,41,.04); }
.searchBar :deep(.el-input__wrapper.is-focus) { box-shadow:0 0 0 1px rgba(79,140,255,.35) inset; }
